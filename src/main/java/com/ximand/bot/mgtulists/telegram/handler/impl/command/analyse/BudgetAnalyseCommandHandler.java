...
@Service
public class BudgetAnalyseCommandHandler extends AbstractAnalyseCommandHandler {

    private static final String NAME = "analyse_budget";

    @Autowired
    public BudgetAnalyseCommandHandler(TelegramUserRepository userRepository,
    ...
    public SendMessage handle(Message message) {
        return super.handle(message, UserActivity.INPUT_DIRECTION_BUDGET);
    }
}
